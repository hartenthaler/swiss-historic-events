...
return new class extends AbstractModule implements ModuleCustomInterface, ModuleHistoricEventsInterface {
     ...
     *
     * tbd: vollständige Daten ggf. als julianisch markieren (wann war in der Schweiz die Umstellung auf den gregorianischen Kalender?)
...
"1 EVEN Erdbeben in Basel\n2 TYPE ".$eventType."\n2 DATE 18 OCT 1356\n2 NOTE mindestens Stärke 9, 100–2000 Menschen verlieren ihr Leben; siehe [wikipedia ".$wikipedia."](https://".$wikipedia.".wikipedia.org/wiki/Basler_Erdbeben_1356 )",
